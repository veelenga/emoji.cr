...
class Emoji::Regex::DataLoader
  ...
  def initialize
    @data_lines = read_lines_from_file("/Public/15.1.0/ucd/emoji/emoji-data.txt")
    @variation_sequences_lines = read_lines_from_file("/Public/15.1.0/ucd/emoji/emoji-variation-sequences.txt")
    @sequences_lines = read_lines_from_file("/Public/emoji/15.1/emoji-sequences.txt")
    @zwj_sequences_lines = read_lines_from_file("/Public/emoji/15.1/emoji-zwj-sequences.txt")
  end
